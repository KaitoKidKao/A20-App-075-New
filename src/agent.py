"""
Agent loop using the OpenAI API with Tool Calling (Function Calling).
Receives user input, calls tools as needed, and logs activity to session.jsonl.
"""
...
def main():
    ...
    client = create_agent()
    print("Agentic App (OpenAI GPT-4o-mini)")
    print("-" * 50)
