...
# Comprehensive Mapping of corrupted strings to correct Vietnamese
restoration_map = {
    "c?ng_ngh?_th?ng_tin": "công_nghệ_thông_tin",
    "m?y_vitinh": "máy_vi_tính",
...
for line in lines:
    fixed_line = line
    # Apply restoration multiple times for nested replacements
    for _ in range(2): 
