        ...
        <div className="flex items-center justify-end gap-6">
          ...
          <div className="group relative flex cursor-pointer items-center gap-3 pl-2">
            ...
            <div className="group/avatar relative">
              ...
              <div className="invisible absolute right-0 top-full mt-2 w-48 rounded-2xl border border-slate-100 bg-white py-2 opacity-0 shadow-xl transition-all group-hover/avatar:visible group-hover/avatar:opacity-100">
                <button
