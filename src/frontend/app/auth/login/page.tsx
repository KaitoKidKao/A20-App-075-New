      ...
      <form onSubmit={handleLogin} className="space-y-5">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <label htmlFor="remember" className="text-sm font-bold text-slate-500 cursor-pointer">Ghi nhớ đăng nhập</label>
          </div>
          <Link href="/auth/forgot-password" className="text-sm font-bold text-[#FF4F6E]/80 hover:text-[#FF4F6E] hover:underline">Quên mật khẩu?</Link>
        </div>
        ...
        <div className="relative py-2">
          ...
          <div className="relative flex justify-center text-xs font-bold text-slate-400">
            <span className="bg-[#FFF9FA] px-4 uppercase tracking-widest">Hoặc</span>
          </div>
        </div>
        ...
        <div className="text-center pt-4 space-y-4">
          <p className="text-sm font-medium text-slate-500">
            Chưa có tài khoản?
            <Link href="/auth/register" className="text-[#FF4F6E] font-bold hover:underline ml-1">Đăng ký</Link>
          </p>
          ...
          {process.env.NODE_ENV === 'development' && (
            ...
            >
              Bỏ qua đăng nhập (chỉ dành cho Dev)
            </button>
          )}
        </div>
      </form>
