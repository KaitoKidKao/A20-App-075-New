    ...
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <form onSubmit={handleLogin} className="space-y-6">
        ...
        <div className="flex flex-col gap-4">
          <button type="button" className="w-full flex items-center justify-center gap-3 py-4 bg-slate-50 border border-slate-100 rounded-2xl font-bold text-slate-700 hover:bg-slate-100 transition-all">
